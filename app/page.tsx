...
const QUICK_LINKS: { icon: QuickIcon; label: string; sub: string; href: string }[] = [
  { icon: IconBook, label: 'Chapters', sub: 'Full module content', href: '/chapters' },
  { icon: IconUsers, label: 'NPCs', sub: 'Searchable reference', href: '/npcs' },
  { icon: IconSwords, label: 'Encounter', sub: 'Initiative & stat blocks', href: '/encounter' },
  { icon: IconNotebook, label: 'Session Log', sub: 'Live notes & export', href: '/session-log' },
  { icon: IconBooks, label: 'Reference', sub: 'Sins, locations, lore', href: '/reference' },
]
