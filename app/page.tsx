...
const QUICK_LINKS = [
  ...
  { icon: '👥', label: 'NPCs', sub: 'Searchable reference', href: '/npcs' },
  {
    icon: '⚔️',
    label: 'Encounter',
    sub: 'Initiative & stat blocks',
    href: '/encounter',
  },
  {
    icon: '📝',
    label: 'Session Log',
    sub: 'Live notes & export',
    href: '/session-log',
  },
  {
    icon: '📚',
    label: 'Reference',
    sub: 'Sins, locations, lore',
    href: '/reference',
  },
];
          ...
          {SINS.map((sin) => (
            <div
              ...
              style={{
                ...
                borderLeft: `3px solid ${sin.color}`,
                borderRadius: '4px',
              }}
            >
              <span
      ...
      <div>
        ...
        >
          {[
            {
              player: 'Mikey',
              char: 'Rolando Ornasca',
              cls: 'Drow Sun Soul Monk',
              lvl: 3,
            },
            {
              player: 'Kilt',
              char: 'Michael Portsmith',
              cls: 'Halfling PDK Fighter',
              lvl: 3,
            },
            {
              player: 'Will',
              char: 'Thornvatore',
              cls: 'Dwarf Paladin of Devotion',
              lvl: 3,
            },
            {
              player: 'JT',
              char: 'Drazier "Gabriel"',
              cls: 'Tiefling Valor Bard',
              lvl: 3,
            },
          ].map((pc) => (
            <div
