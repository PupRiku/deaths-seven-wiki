...
export const npcs: NPC[] = [
...

  {
    ...
    arc: 'Ch.10 — Lust',
    description: "Beneath the diamond mask: not a rotting face but a void. Pale perfect skin stretched over something that is not quite a face. A mouth full of needles arranged into a smile. Eyes that reflect the room back rather than looking out.",
    ...
    notes: [
      "Host is a recently consumed widow named Seraphel who came to Veilmoor in grief (VERSION B: this may be Drazier's priestess — coordinate with JT)",
      "VERSION A: Priestess of Nyx is alive in the city, separate from the Matriarch",
      "VERSION B: Priestess IS the Matriarch — Drazier must fight the woman he loved",
      "The Matriarch holds Grand Masquerade every night — gates open to all. She craves adoration.",
      "Charm of Vanity CANNOT target Thornvatore — Sin cannot categorize his desire",
      "Post-Siphon: shivering on the ballroom floor, not knowing where she is. Party's choice what happens next.",
    ],
    firstAppearance: 10,
    statBlock: {
