...
const chapter: Chapter = {
      ...
      levelStart: 3,
      levelEnd: 4,
      summary: "The party awakens in unfamiliar bodies, meets their guide Fizzle, travels to Nova Clarus, receives their first mission, is captured by General Draven, and escapes the Mountain Dungeon with the Relic Stone — unknowingly aided by the Aspirant.",
      sections: [
        {
          title: "Introduction",
          type: "prose",
          content: "You are dead. Or rather — you were. The cold, silent embrace of death was the last thing you knew. Now, inexplicably, impossibly, you feel grass beneath your fingers and sunlight on your face. You open your eyes to a sky that is too bright, in a body that is not quite yours.",
        },
        {
          title: "Opening — The Field",
          type: "scene",
          content: "The party awakens in a grassy field with no gear beyond simple clothes. They are in new, randomized bodies — different species, different abilities, different everything. Give each player a moment to react to their new form before the chaos begins.",
          boxedText: "The last thing you remember is the cold, silent embrace of death. Now, you feel... grass. You smell... air. You open your eyes to a bright blue sky, feeling the aches and pains of a body that is not your own. A frantic, high-pitched voice cuts through your confusion. \"Oh good! You're awake! Finally! I was getting soooooooo bored! I'm Fizzle, and — oh dear — we have so much to do. Your boss, my boss, well, our boss, Nyx, you know, the Nyx, has a job for you!\"",
          dmNote: "Fizzle is being chased by a small pack of goblins as she delivers this speech. Let the players react to their new forms — strange species combinations, unexpected abilities — before calling for initiative. This is a low-stakes 'shake the rust off' encounter. Let them be weird and experimental. Fizzle can react to particularly unusual ability uses with delighted or baffled commentary.",
        },
        {
        ...
        },
        {
          ...
          dmNote: "This scene exists entirely to be destroyed. Give Mama Bess a line or two that sticks — a joke, a piece of unsolicited advice, a moment of genuine warmth. Let Bucket sniff a character and fall asleep on their foot. Give the players five minutes to feel safe and at home. The contrast with the burned village is everything. Do not rush it.",
        },
        {
          title: "Fizzle's Briefing",
          type: "scene",
          content: "Once the party is settled at the inn — fed, cleaned up, and seated somewhere warm — Fizzle produces a small magical token with great ceremony and delivers her briefing. This is the full scope of their mission, delivered in a safe and cozy space. Before everything changes.",
          keyInfo: [
          ...
          dmNote: "Fizzle does not know everything. She can answer basic questions but deflects anything too specific with 'Nyx didn't tell me that part!' She is genuinely trying her best. Play her as overwhelmed but enthusiastic — she cares about the party even if she met them thirty seconds ago. Mama Bess will almost certainly interrupt at least once with a refill or an unsolicited comment. Let her.",
        },
        {
          title: "Nova Clarus — The Nova Sentinels",
          type: "scene",
          content: "Fizzle guides the party to Nova Clarus and directly to the headquarters of the Nova Sentinels — the city's elite special forces. Their motto is carved above the door: 'We don't start fights, but we'll finish them.'",
          boxedText: "The half-orc commander sizes you up, her gaze lingering on your mismatched forms. \"Fizzle says you're good in a scrap. Fine. I don't know what god-snot you crawled out of, but the Sentinels need bodies. We have a saying here: 'Don't do anything stupid.' Your first job is simple. That village you just came from — Janus? We've lost contact. Probably just a broken signal, but I need a team to go check it out. Go there, see what's wrong, and report back. No heroics. Understand?\"",
          keyInfo: [
          ...
          dmNote: "Nazura knows who the party really is — she is one of three people in Nova Clarus who do. She is testing them here, not genuinely treating them as raw recruits. She keeps this knowledge secret for now. Play her as gruff but fair. She wants to believe in them.",
        },
        {
          title: "Mission 1 — The Ashes of Janus",
          type: "scene",
          content: "As the party travels back toward Janus, Fizzle chatters excitedly, asking about their old lives — a natural opening for players to share backstory. The mood breaks the moment they crest the final hill.",
          boxedText: "The cheerful chatter dies in Fizzle's throat. The smell hits you first — acrid, choking smoke. A light wind carries a piece of burnt parchment, a flier for the very inn you just stayed at. As you crest the final hill, you see what remains of Janus. It is a smoldering, black scar on the landscape.",
          dmNote: "No bodies. Only drag marks and footprints. The village was not massacred — it was emptied. Soldiers from Wrath's army (use Guard or Thug stat blocks) are still on site, turning over debris looking for survivors to kill or capture. The party should feel the weight of this before combat begins — the inn they visited, the faces they may have spoken to, all of it gone.",
          bucket: {
            discovery: "As the party searches the ruins of the inn, a DC 10 Perception check — or simply following a faint sound — leads them to the kitchen, the one room with enough standing walls to offer shelter. Bucket is curled there, nursing a litter of four newborn blink pups. Their eyes are not yet open. They blink sporadically and uncontrollably — tiny flickering teleportations, appearing and disappearing a few inches at a time in the straw. Bucket looks up at the party and wags her tail once, slowly. Then she looks toward the door, waiting.",
            encounter: "This is the moment the thugs arrive. The sound of boots on rubble. The party must fight — but Fizzle, seeing the pups, immediately volunteers to handle them. She spends the entire combat frantically chasing newborn blinking puppies around the ruined kitchen, appearing and disappearing after them, muttering increasingly stressed fairy profanity. She keeps them safe. She is very stressed about it.",
            aftermath: "When the fight is over and the dust settles, Bucket does not stay with the pups. She moves slowly through the ruins of the inn, sniffing at the places Mama Bess used to stand — the bar, the hearth, the kitchen door. Then she finds the fireplace. She circles once. She lies down. She puts her head on her paws. Fizzle goes very quiet. If asked, she says softly: 'She's not in pain. She's just... done. She was waiting to make sure everyone was okay.' Bucket's tail wags once more. Then she closes her eyes.",
            dmNote: "Do not narrate Bucket's death explicitly. Let it happen in the background, gently, while the party is tending to wounds and collecting themselves. Fizzle sensing it is the signal — her going quiet is the tell. The pups are the party's now, whether they planned for it or not. Four newborn blink dogs with no mother, no home, and no idea how their own abilities work yet. What the party does next is up to them entirely.",
          },
        },
        {
          title: "Encounter 2 — Wrath's Soldiers",
          type: "encounter",
          content: "A squad of Wrath's soldiers is combing the ruins for survivors. After the party defeats them, their leader arrives.",
          creatures: ["6 Guards (MM p.347) or Thugs (MM p.350) — Wrath-Infused (eyes glow red, steam rises from skin)"],
          tactics: "The soldiers fight aggressively and without mercy. They do not retreat. If the party seems to be struggling, reduce the number. This fight should be winnable but feel serious.",
          dmNote: "Let the party have a genuine victory here. They need to feel capable before Draven walks out. The contrast is everything.",
        },
        {
          title: "Encounter 3 — General Draven (Unwinnable)",
          type: "encounter",
          content: "After the soldiers fall, their general emerges from the ruins of the inn. This fight cannot be won. The party will be captured.",
          boxedText: "A massive figure, clad in scorched black plate armor, steps from the ruins of the inn. He applauds slowly, his metal gauntlets making a sharp, metallic clang. \"Impressive. Truly. I don't know what hole you crawled out of, but you fight like people who have died before. But there is a difference between courage and survival. You have the first. You lack the second.\" He raises one hand. The treeline fills with soldiers. \"Rest. You've earned it.\"",
          creatures: ["General Draven (custom stat block — late game boss, use as needed for narrative)"],
          tactics: "Draven is immune to non-magical bludgeoning, piercing, and slashing damage. Immune to fire and poison. Resistant to all other magic. Any physical attack against him — hit or miss — provokes an immediate counterattack dealing massive non-lethal damage, designed to drop a level 3 character in one hit. The combat ends when all party members are unconscious or surrender.",
          dmNote: "CRITICAL: Make it clear the party is knocked unconscious, not dying. No death saves. They wake up in a cell. Draven's tone is key — he is not contemptuous. He is impressed. He respects the fight. He ends it anyway. The 'died before' line is dramatic irony he does not understand yet. Let it land.",
        },
        {
          title: "The Mountain Dungeon — Layer 1: The Cell",
          type: "scene",
          content: "The party wakes in a large communal cell, stripped of all gear. One barred door. A torch in the corridor outside, just out of reach. A guard patrols past every 10 minutes.",
          keyInfo: [
          ...
          dmNote: "Do not rush this puzzle. Let the party explore, theorize, and experiment. The drain red herring pays off with the map — no investigation is wasted. The ventilation shaft that 'leads nowhere' is secretly the core mechanism. Players who find the map will feel clever in Layer 2. Players who engineer the magnet-wire solution will feel like a team.",
        },
        {
          title: "The Mountain Dungeon — Layer 2: The Escape",
          type: "scene",
          content: "Once free of the cell, the party must navigate the dungeon, locate their gear, find the Relic Stone, and encounter the Aspirant — all without alerting the garrison.",
          keyInfo: [
          ...
          dmNote: "The Aspirant's cell sits between the gear room and the caved-in section — the party passes it going both directions. He calls out the first time they pass. His timing is deliberate.",
        },
        {
          title: "The Aspirant — The Beggar",
          type: "scene",
          content: "As the party moves through the dungeon, a voice calls out from a dark cell.",
          boxedText: "\"No, wait! Please, don't leave me! They'll kill me... I know things about this place! I know how to get out — and how to get back at that monster! Please!\"",
          keyInfo: [
          ...
          dmNote: "Play him as pathetic, grateful, and just credible enough. He is not over-the-top villainous — he is calm, clever, and completely in control of this interaction while appearing to be at the party's mercy. His refusal to leave should feel selfless. It is the opposite. He has no intention of leaving his observation post. The party will likely feel warmly toward him. Good.",
        },
        {
          title: "The Escape & Conclusion",
          type: "scene",
          content: "The party escapes through the fissure the Aspirant indicated, emerging into the wilderness and making their way back to Nova Clarus. They carry the Relic Stone and a (false) sense of having made a friend on the inside.",
          ...
          dmNote: "End the chapter on the reveal — Nazura's reaction to the Relic Stone is the cliffhanger. 'Say that again. The stone.' Let that moment breathe before you call it a session.",
        },
      ],
    }
